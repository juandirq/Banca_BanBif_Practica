...
export default function App() {
  ...
  const metrics = useMemo(() => {
    ...
    const transferCountFromApi = Number(dashboard?.transfer_count ?? NaN);

    const transfers = Number.isFinite(transferCountFromApi)
      ? transferCountFromApi
      : movements.filter((m) => {
  ...
  }, [payments, credits, movements, dashboard]);
